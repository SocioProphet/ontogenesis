...
- `rcg:` `https://socioprophet.github.io/ontogenesis/middle/reciprocal-channel-governance#`
...
- Use the `rcg:` namespace only as the semantic mirror for ProCybernetica Reciprocal Channel Governance doctrine; it does not replace ProCybernetica as the doctrine authority.
