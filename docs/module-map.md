...
- `bindings/valueflows_governed/`
  ...
  - ontology-native semantic lift is now present via `bindings/valueflows_governed/valueflows-governed.context.jsonld`, `shapes/valueflows-governed.shacl.ttl`, and `examples/valueflows-governed-task-flow-demo.jsonld`
